 ...
 ***** API for this request *****
 ...
 //adverts.local/advert/c4ca4238a0b923820dcc509a6f75849b/banner_468x60?u=2&debugging=false&advert=&keywords=&mustContain=&mustNotContain=
...
ADSSCRIPT['ad2'] = (function () {
	...
	return function () { //Public function
		...
		debugging_function("API: //adverts.local/advert/c4ca4238a0b923820dcc509a6f75849b/banner_468x60?u=2&debugging=false&advert=&keywords=&mustContain=&mustNotContain=",options,"info");
		debugging_function("SCRIPT: //adverts.local/c4ca4238a0b923820dcc509a6f75849b/banner_468x60.js?u=2&debugging=false&advert=&keywords=&mustContain=&mustNotContain=",options,"info");
		...
		if (data.advert && data.advert.ID) {
			...
			!(function(options,data) {
				...
				debugging_function("banner_468x60 SCRIPT",options,"group");
				debugging_function(advert,options);

				var container = document.createElement("div");
				container.className = "ad-server-block";

//	container.innerHTML += "<img src='//adverts.local/" + options.module + "/" + options.siteID + "/" + advert.key + "/banner/1px_transparent.png' style='width:1px; height:1px;' />";

				container.innerHTML =  Base64.decode("PGltZyBzcmM9Jy8vYWR2ZXJ0cy5sb2NhbC8vLy9iYW5uZXIvJyBzdHlsZT0nbWF4LXdpZHRoOiA0NjhweDsgbWF4LWhlaWdodDo2MHB4OyB3aWR0aDoxMDAlOyBoZWlnaHQ6MTAwJTsnLz4=");
				...
				debugging_function("banner_468x60 SCRIPT",options,"groupEnd");
